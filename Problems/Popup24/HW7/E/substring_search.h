...
{
    // kmp_table[i] = there is a match from word[0] to word[i - 1] in the text, but text[j] != word[i], how far do we
    // need to go back in our word that we search for to find a match
